    ...
    <main className="container my-5" aria-label="Upload new artwork form">
      ...
      <form aria-labelledby="upload-artwork-heading">
        ...
        <div className="mb-3">
          ...
          <input type="file" className="form-control" id="artworkImage" aria-label="Upload artwork image" />
        </div>

        <div className="mb-3">
          <label htmlFor="titleInput" className="form-label">Title</label>
          <input type="text" className="form-control" id="titleInput" aria-label="Artwork title" />
        </div>

        <div className="mb-3">
          <label htmlFor="descriptionInput" className="form-label">Description</label>
          <textarea className="form-control" id="descriptionInput" rows="4" aria-label="Artwork description"></textarea>
        </div>
        ...
        <fieldset className="mb-4">
          ...
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="oilPaint" value="oil-paint" />
            <label className="form-check-label" htmlFor="oilPaint">Oil Paint</label>
          </div>
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="acrylicPaint" value="acrylic-paint" />
            <label className="form-check-label" htmlFor="acrylicPaint">Acrylic Paint</label>
          </div>
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="digitalArt" value="digital-art" />
            <label className="form-check-label" htmlFor="digitalArt">Digital Art</label>
          </div>
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="sculpture" value="sculpture" />
        ...
        <fieldset className="mb-4">
          ...
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="people" value="people" />
            <label className="form-check-label" htmlFor="people">People</label>
          </div>
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="love" value="love" />
            <label className="form-check-label" htmlFor="love">Love</label>
          </div>
          <div className="form-check form-check-inline">
            <input type="checkbox" className="form-check-input" id="animals" value="animals" />
